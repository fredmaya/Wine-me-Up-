    ...
    <div>
      ...
      <main>
        <section className="info">
          <p>
            Hey there, welcome to Wine me UP! - your go-to spot for nailing that
            perfect food and wine combo!{" "}
          </p>
          <p>
          ...
          <p>
            Picture this: you're craving a juicy burger or maybe a creamy pasta.
            What wine do you pair it with?{" "}
          </p>
          <p>
            That's where we step in. Our site's like your fun, easygoing friend
            who just happens to know a ton about wine.{" "}
          </p>
          <p>
            We'll guide you through our awesome selection, matching your fave
            dishes with the perfect vino. From fancy reds to refreshing whites,
            we've got bottles from all over the globe, just waiting to jazz up
            your meal.{" "}
          </p>
          <p>
